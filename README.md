...
## Documentation
- docs/Recap-et-Reproduction.md — Récapitulatif et instructions JWT/Frontend
- smartimmat/docs/What-I-Did-And-How-To-Reproduce.md — Explication des changements DB (files + file_history) et étapes pour reproduire


## Nouvelle fonctionnalité: Compression d'image et PDF
- Une nouvelle page Dashboard → Compresser permet de réduire la taille des images (JPG/PNG) et des PDF directement dans le navigateur.
- Option d'envoyer le fichier compressé dans l'historique via le même endpoint d'upload.
- Voir le guide: smartimmat/docs/Guide-Compression.md
